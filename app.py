...
st.set_page_config("myntra-new-review-scrapper")
...
def form_input():
    ...
    no_of_product=st.number_input("Enter no of product ",step=1,min_value=1)

    if st.button("Scrape Review"):
        scrapper=ScrapeReviews(product_name=product,no_of_products=int(no_of_product))
